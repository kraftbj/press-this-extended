 ...
 *
 * Note: These styles can be overridden by calling press_this_extended_override_style()
 * in lib/client-assets.php for complex cases (multiple files, conditional deps, etc.)
 *
 * @package press_this_extended
 */

if ( ! function_exists( 'press_this_extended_override_style' ) ) {
	/**
	 ...
	 */
	function press_this_extended_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
...
if ( ! function_exists( 'press_this_extended_register_package_styles' ) ) {
	/**
	 ...
	 * @param WP_Styles $styles WP_Styles instance.
	 */
	function press_this_extended_register_package_styles( $styles ) {
		...
		foreach ( $styles_data as $style_data ) {
			press_this_extended_override_style(
				$styles,
				$style_data['handle'],
	...
	add_action( 'wp_default_styles', 'press_this_extended_register_package_styles' );
}
