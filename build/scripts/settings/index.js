var pressThisExtended;
(pressThisExtended ||= {}).settings = (() => {
  ...
  // packages/settings/src/index.jsx
  var import_element2 = __toESM(require_element());
  var import_i18n2 = __toESM(require_i18n());

  // packages/settings/src/settings.jsx
  ...
  function SettingsPage() {
    ...
    const [isSaved, setIsSaved] = (0, import_element.useState)(false);
    ...
    if (isLoading) {
      return /* @__PURE__ */ React.createElement(import_components.Flex, { justify: "center", style: { padding: "40px" } }, /* @__PURE__ */ React.createElement(import_components.Spinner, null));
    }
    return /* @__PURE__ */ React.createElement("div", { className: "press-this-extended-settings wrap" }, /* @__PURE__ */ React.createElement("h1", null, (0, import_i18n.__)("Press This Extended Settings", "press-this-extended")), notice && /* @__PURE__ */ React.createElement(
      ...
      notice.message
    ), /* @__PURE__ */ React.createElement("div", { className: "pte-settings-cards" }, /* @__PURE__ */ React.createElement(import_components.Card, null, /* @__PURE__ */ React.createElement(import_components.CardHeader, null, /* @__PURE__ */ React.createElement("h2", null, (0, import_i18n.__)("Content Discovery", "press-this-extended"))), /* @__PURE__ */ React.createElement(import_components.CardBody, null, /* @__PURE__ */ React.createElement(
    ...
    ))), /* @__PURE__ */ React.createElement(import_components.Card, null, /* @__PURE__ */ React.createElement(import_components.CardHeader, null, /* @__PURE__ */ React.createElement("h2", null, (0, import_i18n.__)("Formatting", "press-this-extended"))), /* @__PURE__ */ React.createElement(import_components.CardBody, null, /* @__PURE__ */ React.createElement(
    ...
    ))), /* @__PURE__ */ React.createElement(import_components.Card, null, /* @__PURE__ */ React.createElement(import_components.CardHeader, null, /* @__PURE__ */ React.createElement("h2", null, (0, import_i18n.__)("Redirection", "press-this-extended"))), /* @__PURE__ */ React.createElement(import_components.CardBody, null, /* @__PURE__ */ React.createElement(
      import_components.CheckboxControl,
      {
        __nextHasNoMarginBottom: true,
    ...
    ))), /* @__PURE__ */ React.createElement("p", { className: "submit" }, /* @__PURE__ */ React.createElement(
      ...
      isSaving && (0, import_i18n.__)("Saving\u2026", "press-this-extended"),
      isSaved && (0, import_i18n.__)("Saved!", "press-this-extended"),
      !isSaving && !isSaved && (0, import_i18n.__)("Save Settings", "press-this-extended")
    ))));
  }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (container) {
      const root = (0, import_element2.createRoot)(container);
