	...
	function help_tab() {
		get_current_screen()->add_help_tab( array(
			...
			'content' => '<p>' . __( 'These options allow you to customize the Press This bookmarklet to do some cool stuff.' ) . '</p>' .
			           ...
			           . '<p>' . __( 'Text Editor adds the HTML option found in the common editor. Some features of Press This, such as inserting the suggested media or the Save Draft text changing may not work as expected when using the text editor.', 'press-this-extended' ) . '</p>',
			)
		);
	}
